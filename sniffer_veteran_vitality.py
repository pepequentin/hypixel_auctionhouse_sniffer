...
def process_auction(auction):
    ...
    if auction["bin"] and auction["item_name"].find(item_necklace) != -1:
        if auction["item_lore"].find("Veteran") != -1 and auction["item_lore"].find("Vitality") != -1:
            match = re.search(r"Veteran ([IVXLCDM]+)", auction["item_lore"])
            magic_find = match.group(1)
            match = re.search(r"Vitality ([IVXLCDM]+)", auction["item_lore"])
            vitality_attrib = match.group(1)

            results.append("    Necklace             : " + str(auction["starting_bid"]) + "  magic_find : " + str(magic_find) + "                       Vitality : " + str(vitality_attrib) + " " + auction["tier"] + " " + auction["item_name"])
    if auction["bin"] and auction["item_name"].find(item_bracelet) != -1:
        if auction["item_lore"].find("Veteran") != -1 and auction["item_lore"].find("Vitality") != -1:
            ...
            results.append("    Bracelet             : " + str(auction["starting_bid"]) + "  magic_find : " + str(magic_find) + "                       Vitality : " + str(vitality_attrib) + " " + auction["tier"] + " " + auction["item_name"])
    if auction["bin"] and auction["item_name"].find(item_cloak) != -1:
        if auction["item_lore"].find("Veteran") != -1 and auction["item_lore"].find("Vitality") != -1:
            ...
            results.append("    Cloak                : " + str(auction["starting_bid"]) + "  magic_find : " + str(magic_find) + "                       Vitality : " + str(vitality_attrib) + " " + auction["tier"] + " " + auction["item_name"])
    ...
    if auction["bin"] and auction["item_name"].find(item_Gauntlet) != -1:
        if auction["item_lore"].find("Veteran") != -1 and auction["item_lore"].find("Vitality") != -1:
            ...
            results.append("    Gauntlet             : " + str(auction["starting_bid"]) + "  magic_find : " + str(magic_find) + "                       Vitality : " + str(vitality_attrib) + " " + auction["tier"] + " " + auction["item_name"])
    ...
    if auction["bin"] and auction["item_name"].find(item_belt) != -1:
        if auction["item_lore"].find("Veteran") != -1 and auction["item_lore"].find("Vitality") != -1:
            ...
            results.append("    Belt                 : " + str(auction["starting_bid"]) + "  magic_find : " + str(magic_find) + "                       Vitality : " + str(vitality_attrib) + " " + auction["tier"] + " " + auction["item_name"])



    # Recherche l'objet "" pour des enchères epic à bas prix.
    if auction["bin"] and auction["item_name"].find(item_necklace) != -1:
        if auction["item_lore"].find("Veteran") != -1:
            match = re.search(r"Veteran ([IVXLCDM]+)", auction["item_lore"])
            magic_find = match.group(1)
    ...
    if auction["bin"] and auction["item_name"].find(item_necklace) != -1:
        if auction["item_lore"].find("Vitality") != -1:

            match = re.search(r"Vitality ([IVXLCDM]+)", auction["item_lore"])
            vitality_attrib = match.group(1)

            results.append("    Necklace             : " + str(auction["starting_bid"]) + " Vitality : " + str(vitality_attrib) + " " + auction["tier"] + " " + auction["item_name"])
    if auction["bin"] and auction["item_name"].find(item_bracelet) != -1:
        if auction["item_lore"].find("Vitality") != -1:
            ...
            results.append("    Bracelet             : " + str(auction["starting_bid"]) + " Vitality : " + str(vitality_attrib) + " " + auction["tier"] + " " + auction["item_name"])
    if auction["bin"] and auction["item_name"].find(item_cloak) != -1:
        if auction["item_lore"].find("Vitality") != -1:
            ...
            results.append("    Cloak                : " + str(auction["starting_bid"]) + " Vitality : " + str(vitality_attrib) + " " + auction["tier"] + " " + auction["item_name"])
    ...
    if auction["bin"] and auction["item_name"].find(item_Gauntlet) != -1:
        if auction["item_lore"].find("Vitality") != -1:
            ...
            results.append("    Gauntlet             : " + str(auction["starting_bid"]) + " Vitality : " + str(vitality_attrib) + " " + auction["tier"] + " " + auction["item_name"])
    ...
    if auction["bin"] and auction["item_name"].find(item_belt) != -1:
        if auction["item_lore"].find("Vitality") != -1:
            ...
            results.append("    Belt                 : " + str(auction["starting_bid"]) + " Vitality : " + str(vitality_attrib) + " " + auction["tier"] + " " + auction["item_name"])
